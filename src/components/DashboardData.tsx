    ...
    <div className="space-y-6">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
          ...
          <div className="relative w-full max-w-5xl bg-surface border border-border/80 rounded-2xl shadow-2xl p-6 overflow-hidden max-h-[85vh] flex flex-col animate-in zoom-in-95 duration-200 z-10">
            {/* Close button */}
            <button
                      ...
                      >
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[8px] px-1.5 py-0.5 bg-primary/10 border border-primary/20 text-primary rounded font-semibold leading-none">
                              {stock.score} score
                            </span>
                            {stock.sector && (
                              <span className="text-[8px] px-1.5 py-0.5 bg-white/5 border border-white/10 text-text-muted rounded font-bold uppercase leading-none">
                                {stock.sector}
                              </span>
                            )}
                          </div>
                        ...
                        <div className="text-right ml-3 flex-shrink-0 flex items-center gap-3">
                          ...
                          <span className="text-xs font-bold text-green-400 bg-green-500/10 px-2 py-0.5 rounded min-w-[60px] text-center group-hover/stock:hidden leading-none">
                    ...
                    .map((stock: any) => (
                      ...
                      >
                        ...
                        <div className="text-right ml-3 flex-shrink-0 flex items-center gap-3">
                          ...
                          <span className="text-xs font-bold text-red-400 bg-red-500/10 px-2 py-0.5 rounded min-w-[60px] text-center group-hover/stock:hidden leading-none">
                            {stock.change ? stock.change.toFixed(2) : "0.00"}%
                          </span>
                          <span className="text-[9px] px-2 py-1 bg-primary text-primary-foreground rounded-lg font-bold hidden group-hover/stock:flex items-center gap-1 shadow-md animate-in fade-in duration-200">
                            <LineChart className="w-3 h-3" /> Analyse
